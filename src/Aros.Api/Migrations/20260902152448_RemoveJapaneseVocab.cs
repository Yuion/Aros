...
{
    /// <inheritdoc />
    public partial class RemoveJapaneseVocab : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetRomaji = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SelectedVocabEntryId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    RomajiCorrect = table.Column<bool>(type: "boolean", nullable: true),
                    TestType = table.Column<int>(type: "integer", nullable: false),
                    TimeTakenMs = table.Column<int>(type: "integer", nullable: false),
                    TranslationCorrect = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.SelectedVocabEntryId,
